...
- (void)userBannerWithParams:(NSDictionary *)params completion:(void (^)(NSDictionary *bannerUrls, NSError *error))completion {
    [self GET:@"1.1/users/profile_banner.json" parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSDictionary *bannerUrls = (NSDictionary *)responseObject;
