...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *rightBarButtonItem =[[UIBarButtonItem alloc] initWithTitle:@"New" style:UIBarButtonItemStylePlain target:self.hamburgerViewController action:@selector(onCompose)];
